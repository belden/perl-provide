# This Makefile is for the provide extension to perl.
#
...
#     ABSTRACT => q[easily choose between different version-specific implementations]
#     AUTHOR => [q[Belden Lyman <belden@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     META_MERGE => { resources=>{ bugtracker=>q[https://github.com/belden/perl-provide/issues], repository=>q[https://github.com/belden/perl-provide] } }
#     NAME => q[provide]
#     PL_FILES => {  }
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/provide.pm]
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ...
	  lib/provide.pm $(INST_MAN3DIR)/provide.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''easily choose between different version-specific implementations'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Belden Lyman <belden@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: provide' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  bugtracker: https://github.com/belden/perl-provide/issues' >> META_new.yml
	$(NOECHO) $(ECHO) '  repository: https://github.com/belden/perl-provide' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.03' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "easily choose between different version-specific implementations",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Belden Lyman <belden@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "provide",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "web" : "https://github.com/belden/perl-provide/issues"' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "repository" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "url" : "https://github.com/belden/perl-provide"' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>easily choose between different version-specific implementations</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Belden Lyman &lt;belden@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/provide.pm blib/lib/provide.pm \
